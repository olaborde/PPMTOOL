...
/**
 Removes all objects in the pool
 * @discussion This method is called automatically on dealloc. Subclasses may wish to override this method to clean up the pooled objects.
 * @return The previous content of the pool.
 */
